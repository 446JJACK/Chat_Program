...
def main():
    ...
    root.putChild(
        "login",
        File("/home/cbowi001/files/webserverchatroom/newchathtmls/index.html"))  # shorten file path
    root.putChild(
        "chatroom",
        File("/home/cbowi001/files/webserverchatroom/newchathtmls/NEWchatPageV1.html"))  # shorten file path
